...
const DetailsPage = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            <h1 className="mt-10 text-4xl font-bold text-green-700 text-center">{plantData?.plantname}</h1>

            <p className="text-center text-gray-500 mt-2 ">{plantData.description}</p>

            <div className="mt-10 flex flex-col-reverse lg:flex-row items-center gap-10 bg-white shadow-md rounded-2xl p-8">
                ...
                <div className="flex-1 grid grid-cols-1 gap-4 text-sm sm:text-base">
                    ...
                    <h1 className="text-green-800 font-semibold"> Last Watered Date: <span className="text-slate-600 font-normal">{plantData.lastwaterdate}</span></h1>

                    <h1 className="text-green-800 font-semibold"> Next Water: <span className="text-slate-600 font-normal">{plantData.category}</span></h1>
                    ...
                    <h1 className="text-green-800 font-semibold"> Added At: <span className="text-slate-600 font-normal">{plantData.uploadData}</span></h1>
